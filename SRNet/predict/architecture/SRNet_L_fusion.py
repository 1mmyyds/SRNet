...
class SRNet_L(nn.Module):
    def __init__(self, in_channels=64, out_channels=32, num_blocks=30):
    ...
    def forward(self, x):
        ...
        out = self.L_blocks(feat_fusion)  # [b, out_channels, h, w]
        out = self.conv_out(out)  # [b, out_channels, h, w]
        return out